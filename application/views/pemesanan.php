                                                    ...
                                                    <table class="table table-striped table-bordered">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <a class="btn btn-danger " href="?halaman=transaksi&delete=" onclick="return confirm('Anda Yakin Ingin Menghapus Data?')">
                                                                        <li class="fa fa-close"></li>
                                                                    </a>

                                                                    <button class="btn btn-info" name="printdo" type="submit">
