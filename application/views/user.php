...
<div class="wrapper">
  ...
  <div class="content-wrapper" ng-app="Angularshowhide">
    <!-- Main content -->
    <section class="content" ng-controller="showhidectrl">
      <!-- Small boxes (Stat box) -->
      <button id="tombol" ng-click="Bro('show')"><i class="fa fa-circle-o"></i> Show</button>
      <button id="tombol" ng-click="Bro('hide')"><i class="fa fa-circle-o"></i> Hide</button>
      <div class="row" >
        <div class="col-xs-7" ng-show="ini" class="hideByDefault">
          <input type="text" class="form-control" ng-model="nama"> {{ nama }}
        </div>
        <br>
      </div>
      <!-- /.row -->
